...
ALTER TABLE GARDEN_PLANTS.FLOWERS.ROOT_DEPTH
...
SELECT
raw_author:AUTHOR_UID::string, 
raw_author:FIRST_NAME::string, 
raw_author:LAST_NAME::string,
raw_author:MIDDLE_NAME::string
FROM author_ingest_json;
