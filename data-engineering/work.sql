...
AND r.user_event = e.game_event_name WHEN MATCHED THEN
UPDATE
...
CREATE OR REPLACE task AGS_GAME_AUDIENCE.RAW.LOAD_LOGS_ENHANCED warehouse = 'COMPUTE_WH' schedule = '5 minute' AS
...
AND r.GAME_EVENT_NAME = e.GAME_EVENT_NAME WHEN NOT MATCHED THEN
INSERT (IP_ADDRESS,
        GAMER_NAME,
        GAME_EVENT_NAME,
        GAME_EVENT_UTC,
